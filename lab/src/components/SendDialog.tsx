...
export function SendDialog({
  ...
  return (
    ...
    >
      <h4 id={`${id}-title`}>Send {file.name}</h4>
      ...
      <p className="small">
        ...
        recipient&rsquo;s registered encryption key as a <code>KQPB</code> letter, and stored at the lab relay, which
        routes on the recipient key alone.
      </p>
